    ...
    <div class="bg-white rounded-md shadow overflow-hidden max-w-3xl">
        <form wire:submit.prevent="simpanProfil">
            ...
            <div class="px-8 py-4 bg-gray-50 border-t border-gray-100 flex justify-end items-center space-x-3">
                ...
                <x-button-loading wire:click="simpanProfilDelay" loading-target="simpanProfilDelay" class="btn-indigo" type="button">Simpan Profil (dengan delay progress)</x-button-loading>
            </div>
        </form>
    </div>
</div>
